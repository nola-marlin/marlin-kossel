...
#define STRING_CONFIG_H_AUTHOR "(nolaspring, anycubic k2-lp-hb)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "sprin gen mk.1"
...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 130.0 // mm
...
// commented out because not sure what
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
 // custom math for the belt and stepper motors used in the anycubic
...
#define MANUAL_Z_HOME_POS 325.5 // Distance between the nozzle to printbed after homing
